...
- Use the shared `osii.processor_sdk` contract included in `osii`, not a copied SDK.
...
- Build SDK-dependent images from the repository root. Keep commands accurate
  in `README.md` when paths change.
