...
data. Their source lives in `osii-toolbox/` in the main OSII repository, separately
...
podman build --format docker \
  -f osii-toolbox/tabular-dataset-processors/Dockerfile \
...
```bash
uv run --no-project --python 3.11 --with-editable osii-core/processor-sdk --with-editable osii-toolbox/tabular-dataset-processors --with pytest python -m pytest osii-toolbox/tabular-dataset-processors/tests -q
uv run --no-project --python 3.11 --with-editable osii-core/processor-sdk --with-editable osii-toolbox/tabular-dataset-processors python osii-toolbox/tabular-dataset-processors/run.py extractor --host 127.0.0.1
```

The last command stays running. Start the enricher in a second terminal:

```bash
uv run --no-project --python 3.11 --with-editable osii-core/processor-sdk --with-editable osii-toolbox/tabular-dataset-processors python osii-toolbox/tabular-dataset-processors/run.py enricher --host 127.0.0.1
```
